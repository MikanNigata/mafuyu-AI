...
# Backward-compatible name used by the original flat module layout.
...
def ensure_runtime_dirs() -> None:
    """Create mutable runtime directories at application startup."""
    for path in (DATA_DIR, LOGS_DIR, WORKSPACE_DIR, CODEX_BRIDGE_DIR):
...
ROUTER_CONFIDENCE_EARLY_EXIT = float(
    os.environ.get("ROUTER_CONFIDENCE_EARLY_EXIT", "0.85")
)
...
ENABLE_CODEX_BRIDGE_AUTOSTART = (
    os.environ.get("ENABLE_CODEX_BRIDGE_AUTOSTART", "0") == "1"
)
